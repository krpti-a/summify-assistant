    ...
    <div class="relative items-center w-full px-5 mx-auto max-w-7xl md:px-12">
        <div class="text-center">
            ...
            <div class="p-2 pb-6 max-w-lg mx-auto">
                ...
                <p class="truncate">{{$embed_collection->meta_data->type ?? ''}}</p>
            </div>
        </div>
                ...
                <div class="flex-1 min-w-0">
                    ...
                    <form class="flex gap-2 pt-2" id="form-question">
                        ...
                        <input placeholder="Ask any question!"
                               class="w-full p-2 rounded-md border border-gray-600 focus:outline-none" name="question"/>
                        <button id="btn-submit-question" type="submit"
                                class="bg-black text-white shadow px-3 rounded-md flex items-center">Send
                        </button>
                    </form>
                </div>
            </div>
